...
var CreateRequestBuilder = /** @class */ (function (_super) {
    ...
    function CreateRequestBuilder(_entityConstructor, _entity) {
        var _this = _super.call(this, new odata_create_request_config_1.ODataCreateRequestConfig(_entityConstructor, uri_conversion_1.oDataUri)) || this;
    ...
    CreateRequestBuilder.prototype.prepare = function () {
        this.requestConfig.payload = entity_serializer_1.serializeEntity(this._entity, this._entityConstructor);
        return this;
    };
    /**
    ...
    CreateRequestBuilder.prototype.asChildOf = function (parentEntity, linkField) {
        this.requestConfig.parentKeys = uri_conversion_1.oDataUri.getEntityKeys(parentEntity, linkField._entityConstructor);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.build(destination, options)
                        ...
                        return entity_deserializer_1.deserializeEntity(response_data_accessor_1.getSingleResult(response.data), _this._entityConstructor, response.headers);
                    })
