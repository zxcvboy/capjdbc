 ...
 */
declare class BigNumberFieldBase<EntityT extends EntityBase> extends EdmTypeField<EntityT, BigNumber> {
    /**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class BigNumberField<EntityT extends EntityBase> extends BigNumberFieldBase<EntityT> implements SelectableEdmTypeField {
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeBigNumberPropertyField<EntityT extends EntityBase, ComplexT = any> extends BigNumberFieldBase<EntityT> {
    /**
