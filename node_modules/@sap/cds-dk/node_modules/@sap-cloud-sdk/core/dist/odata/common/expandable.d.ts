 ...
 */
export declare type Expandable<EntityT extends EntityBase> = ODataVersionOf<EntityT> extends 'v2' ? never : OneToOneLink<EntityT, any> | OneToManyLink<EntityT, any> | AllFields<EntityT>;
