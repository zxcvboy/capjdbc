...
var UpdateRequestBuilder = /** @class */ (function (_super) {
    ...
    function UpdateRequestBuilder(_entityConstructor, _entity) {
        var _this = _super.call(this, new odata_update_request_config_1.ODataUpdateRequestConfig(_entityConstructor, uri_conversion_1.oDataUri)) || this;
    ...
    UpdateRequestBuilder.prototype.prepare = function () {
        this.requestConfig.keys = uri_conversion_1.oDataUri.getEntityKeys(this._entity, this._entityConstructor);
        var updateBody;
