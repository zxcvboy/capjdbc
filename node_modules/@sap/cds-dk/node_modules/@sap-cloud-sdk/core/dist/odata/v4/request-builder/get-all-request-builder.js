...
var GetAllRequestBuilder = /** @class */ (function (_super) {
    ...
    function GetAllRequestBuilder(_entityConstructor) {
        var _this = _super.call(this, new odata_get_all_request_config_1.ODataGetAllRequestConfig(_entityConstructor, uri_conversion_1.oDataUri)) || this;
    ...
    GetAllRequestBuilder.prototype.expand = function () {
        var expands = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.build(destination, options)
                        ...
                        return response_data_accessor_1.getCollectionResult(response.data).map(function (json) {
                            return entity_deserializer_1.deserializeEntity(json, _this._entityConstructor, response.headers);
                        });
                    })];
            });
        });
