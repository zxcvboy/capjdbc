...
var GetByKeyRequestBuilder = /** @class */ (function (_super) {
    ...
    function GetByKeyRequestBuilder(_entityConstructor, keys) {
        var _this = _super.call(this, new odata_get_by_key_request_config_1.ODataGetByKeyRequestConfig(_entityConstructor, uri_conversion_1.oDataUri)) || this;
    ...
    GetByKeyRequestBuilder.prototype.expand = function () {
        var expands = [];
        for (var _i = 0; _i < arguments.length; _i++) {
