...
var DeleteRequestBuilder = /** @class */ (function (_super) {
    ...
    function DeleteRequestBuilder(entityConstructor, keysOrEntity) {
        var _this = _super.call(this, new odata_delete_request_config_1.ODataDeleteRequestConfig(entityConstructor, uri_conversion_1.oDataUri)) || this;
        _this._entityConstructor = entityConstructor;
        if (keysOrEntity instanceof entity_1.Entity) {
            _this.requestConfig.keys = uri_conversion_1.oDataUri.getEntityKeys(keysOrEntity, entityConstructor);
